...
!(function (exports) {
  ...
  var repeat = 
  simplexn._repeat = function (value, n) {
    var res = [];
  ...
  simplexn.Topology = function (complex, dim) {
    this.computeTopology(complex, dim);
  };

  simplexn.Topology.prototype.computeTopology = function (complex, dim) {
    var complex = complex || [[]];
    var dim;
  ...
  simplexn.Topology.prototype.boundary = function (dim) {
    var dim = dim === undefined ? this.dim - 1 : dim;
    ...
    // this.computeTopology(boundaries[dim], dim);
  ...
  simplexn.geometries.cylinderSurface = function (r, h, n, m) {
    ...
    var n = n || 16;
    var m = m || 2;
    var domain = simplexGrid([repeat(2*pi/n, n), repeat(1./m, m)]);
  ...
  simplexn.geometries.torusSurface = function (r, R, n, m) {
    ...
    var n = n || 12;
    var m = m || 8;
    var domain = simplexGrid([ repeat(2*pi/n, n), repeat(2*pi/m, m)]);
  ...
  */
  ...
  simplexn.geometries.torusSolid = function (r, R, n, m, p) {
    ...
    var m = m || 8;
    var p = p || 2;
    var domain = simplexGrid([ repeat(2*pi/n, n), repeat(2*pi/m, m), repeat(1/pi, p)]);
