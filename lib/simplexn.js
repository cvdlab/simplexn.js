...
!(function (exports) {
  ...
  var orientExtrude = function (array, arrayIndx, dim, i, c) {
    var exchange1, exchange2;

    if (((dim - 1) * i) & 1) {
      exchange1 = arrayIndx - 1;
      exchange2 = exchange1 - 1;
      _swap(array, exchange1, exchange2);
    }
  }
  ...
  simplexn.SimplicialComplex.prototype.extrude = function (hlist) {
    return this._extrude(hlist, orientExtrude);
  }
  ...
  simplexn.SimplicialComplex.prototype._extrude = function (hlist, orient) {
    var orient  = orient || false
    var hlist = hlist || [1];
      ...
      if (hlist[h] >= 0) {
        for (c = 0; c < complexSize; c += 1) {
          ...
          for (i = 0; i < cellLength; i += 1) {
            ...
            if (orient) {
              orient(newComplex, cIndx, newDim, i, c);
            }
          }
        }
      }
  ...
  var orientSimplexGrid = function (array, arrayIndx, dim, i, c) {
    var oldDim = dim - 1;
    var exchange1, exchange2;

    if (((dim & 1) * (c) + (oldDim & 1) * i) & 1) {
      exchange1 = arrayIndx - 1;
      exchange2 = exchange1 - 1;
      _swap(array, exchange1, exchange2);
    }
  ...
  *                 or by an alternation of positive and negative numbers
  ...
  simplexn.geometries.simplexGrid = function (quotesList) {
    ...
    quotesList.forEach(function (quotes, i) {
      simpcomp._extrude(quotes, i === (length - 1) ? orientSimplexGrid : false);
    });
